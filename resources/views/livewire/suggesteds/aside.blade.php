<aside class="w-64 shadow-lg" aria-label="Sidebar">
        ...
        <ul class="space-y-2">
            <li>
                <a href="#"
                    ...
                    <span class="ml-3 font-sans font-extrabold text-2xl">Filters</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="ml-20 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap uppercase" sidebar-toggle-item="">
                        {{__('Make & Model')}}
                    </span>
            ...
            <li>
                ...
                <ul id="dropdown-example1" class="hidden py-2 space-y-2">
                    <li>
                        <input type="checkbox" class="inline" name="seddan" id="seddan">
                            CREW CAB PICKUP 4-DR
                    </li>
                    <li>
                        <input type="checkbox" class="inline" name="pickup" id="pickup">
                            PICK UP
                    </li>
                </ul>
            </li>
            ...
            <li>
                <button type="button"
                    ...
                    aria-controls="dropdown-example3" data-collapse-toggle="dropdown-example3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" viewBox="0 0 20 20" fill="currentColor">
