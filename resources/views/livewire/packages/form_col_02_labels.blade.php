<div class="w-auto flex flex-col">
    <label class="input-group-text mb-2">{{__('Inventory Integratgion') }} </label>
    ...
    <label class="input-group-text mb-2">{{__('Count Clicks In Vehicle') }} </label>
    <label class="input-group-text mb-2">{{__('Count Time See Vehicle') }} </label>
    <label class="input-group-text mb-2">{{__('Count Photos Seen') }} </label>
    <label class="input-group-text mb-2">{{__('Use Order To Search') }} </label>
