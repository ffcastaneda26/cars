...
class CreateVehiclesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('vehicles', function (Blueprint $table) {
            ...
            $table->foreignIdFor(Material::class)->comment('Material inteior');
            $table->unsignedBigInteger('interior_color_id')->nullable()->default(null)->unsigned()->comment('Color Interior');
            $table->unsignedBigInteger('exterior_color_id')->nullable()->default(null)->unsigned()->comment('Color Exterior');
            ...
            // $table->string('engine_full` V',50)->nullable()->default(null)->comment('Motor Completo');
