...
class Genders extends Component
{
    ...
    */
    ...
    {
        $this->rules['main_record.spanish'] = $this->main_record->id ? "required|min:5|max:50|unique:genders,spanish,{$this->main_record->id}"
                                                                     : 'required|min:5|max:50|unique:genders,spanish';
        $this->rules['main_record.english'] = $this->main_record->id ? "required|min:3|max:50|unique:genders,english,{$this->main_record->id}"
                                                                     : 'required|min:3|max:50|unique:genders,english';
